  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-foreground">讨论区</h3>
        <button
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-background"
                    />
                    <button
                      onClick={() => handleComment(post.id)}
                      className="p-1.5 text-blue-600 hover:bg-accent/10 rounded-lg transition-colors"
                    >
